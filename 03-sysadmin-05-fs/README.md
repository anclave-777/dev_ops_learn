...
Ответ: Не могут. Жесткая сслыка - это факически один файл под разными именами с одним inode. При изменении овнера жесткой ссылки изменится овнер исходного файла
```
vagrant@vagrant:~$ ll
-rw-rw-r-- 2 vagrant vagrant       0 Nov 15 18:01 hardlink
-rw-rw-r-- 2 vagrant vagrant       0 Nov 15 18:01 test

vagrant@vagrant:~$ sudo -s
root@vagrant:/home/vagrant# chown root:root hardlink 
root@vagrant:/home/vagrant# ll
-rw-rw-r-- 2 root    root          0 Nov 15 18:01 hardlink
-rw-rw-r-- 2 root    root          0 Nov 15 18:01 test
```
