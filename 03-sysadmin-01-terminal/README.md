...
создать 100000 фафйлов можно  командой touch {1..100000}, 300000 создать не получится ошибка: -bash: /usr/bin/touch: Argument list too long
1. В man bash поищите по `/\[\[`. Что делает конструкция `[[ -d /tmp ]]`
возвращает  0 или 1 от выражения -d /tmp -d возвращает True, если существует директория /tmp
...
root@vagrant:/home/vagrant~$ cd /tmp
root@vagrant:/home/vagrant~$ mkdir new_path_directory
root@vagrant:/home/vagrant~$ cp /bin/bash .
