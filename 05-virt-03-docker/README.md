...
Все зависит от масштабов кластера, если он будет обрабатывать терабиты трафика, то нужно использовать несколько  физических серверов, если данных не много подойдет ВМ.
